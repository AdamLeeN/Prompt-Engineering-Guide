...
<Callout type= "info" emoji="🎓">
  Want to learn more about advanced use cases of Chain-of-Thought? Check out our [new cohort-based course](https://maven.com/AdamLeeN/prompt-engineering-llms?cohortSlug=). Use promo code MAVENAI20 for a 20% discount.
</Callout>
