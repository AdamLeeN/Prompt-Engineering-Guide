...
Voit kokeilla tätä esimerkkiä tässä [Notebook-ympäristössä](https://github.com/AdamLeeN/Prompt-Engineering-Guide/blob/main/notebooks/pe-chatgpt-adversarial.ipynb)-ympäristössä. 
