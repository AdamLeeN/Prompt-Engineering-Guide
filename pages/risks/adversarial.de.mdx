...
Sie können dieses Beispiel in [diesem Notebook](https://github.com/AdamLeeN/Prompt-Engineering-Guide/blob/main/notebooks/pe-chatgpt-adversarial.ipynb) ausprobieren.
