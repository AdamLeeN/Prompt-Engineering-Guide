...
<Cards>
    ...
    href="https://github.com/AdamLeeN/Prompt-Engineering-Guide/blob/main/notebooks/pe-rag.ipynb"
    />
</Cards>
<Callout type= "info" emoji="🎓">
  Vous voulez en savoir plus sur le RAG ? Découvrez notre [nouveau cours basé sur des cohortes](https://maven.com/AdamLeeN/prompt-engineering-llms?cohortSlug=). Utilisez le code promo MAVENAI20 pour une réduction de 20%.
</Callout>
## Références
