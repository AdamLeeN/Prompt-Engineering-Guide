...
Motivated by the high interest in developing with LLMs, we have created this new 大模型学习指南 that contains all the latest papers, advanced prompting techniques, learning guides, model-specific prompting guides, lectures, references, new LLM capabilities, and tools related to prompt engineering.
